...
## Onboarding Stagiaire

Pour bien démarrer ton stage sur Le Phare Blanc :

1. **Setup :** Suis le `Quick Start` ci-dessus.
2. **Lecture :** Lis impérativement le [CONTRIBUTING.md](./CONTRIBUTING.md) (Workflow Git) et le [GUIDELINES.md](./GUIDELINES.md) (Architecture).
3. **Tickets :** Rend-toi sur le [Board Project](https://github.com/users/AnissaPRO/projects/4) et cherche le ticket tagué `Junior-Friendly`.
4. **Validation :** Toute modification passe par une Pull Request avec une revue de code obligatoire.

## Design System (Ladle)

Nous utilisons **Ladle** pour documenter nos composants UI de manière isolée.

- **Lancer Ladle :** `cd frontend && npm run ladle`
- **Port par défaut :** `61000`
- **Objectif :** Tester le rendu pour les personas Gérard (800x600) et Geraldine (Mobile).
